package io.aethibo.combatcoach.shared.user.data.di

import io.aethibo.combatcoach.core.database.CombatCoachDatabase
import io.aethibo.combatcoach.shared.user.data.repository.UserPrefsRepositoryImpl
...
import io.aethibo.combatcoach.shared.user.domain.usecase.loadUserPrefs
import io.aethibo.combatcoach.shared.user.domain.usecase.saveUserPrefs
