...
import io.aethibo.combatcoach.shared.user.domain.failure.UserPrefsFailure

fun io.aethibo.combatcoach.shared.user.domain.failure.UserPrefsFailure.toUiError(): UiError = when (this) {
